...
class Prestamo(db.Model):
    ...
    fecha_devolucion = db.Column(db.Date, nullable=True, comment='Fecha de devolución del libro')  
    ...
    def __repr__(self):
        return (
            ...
            f"observaciones='{self.observaciones}', id_estado={self.id_estado}, id_tipo_estado={self.id_tipo_estado})>"
        )